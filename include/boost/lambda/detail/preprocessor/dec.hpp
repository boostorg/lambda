...
#define BOOST_PREPROCESSOR_DEC_MAX 128

#define BOOST_PREPROCESSOR_DEC(x) BOOST_PREPROCESSOR_DEC_DELAY1(x)
#define BOOST_PREPROCESSOR_DEC_DELAY1(x) BOOST_PREPROCESSOR_DEC_DELAY0(x)
#define BOOST_PREPROCESSOR_DEC_DELAY0(x) BOOST_PREPROCESSOR_DEC##x
