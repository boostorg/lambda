...
#define BOOST_PREPROCESSOR_INC_MAX 127

#define BOOST_PREPROCESSOR_INC(x) BOOST_PREPROCESSOR_INC_DELAY1(x)
#define BOOST_PREPROCESSOR_INC_DELAY1(x) BOOST_PREPROCESSOR_INC_DELAY0(x)
#define BOOST_PREPROCESSOR_INC_DELAY0(x) BOOST_PREPROCESSOR_INC##x
